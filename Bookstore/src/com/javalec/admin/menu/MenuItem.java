...
public class MenuItem extends JButton{
	...
	public MenuItem(String name, int index, boolean subMenuAble) {
		...
		setForeground(new Color(234, 234, 234)); //subItem 글씨
	...
	public void initSubMenu(int subMenuIndex, int length) {
		...
		setBackground(new Color(27, 60, 117));	//subMenuItem backgroud 색상
//		setBackground(new Color(34, 67, 124));	//subMenuItem backgroud 색상
//		setBackground(new Color(234, 234, 234));	//subMenuItem backgroud 색상 - white
		setOpaque(true);
	...
	protected void paintComponent(Graphics g) {
		...
		if(length != 0) {
			g2.setColor(new Color(234, 234, 234));	//line 색 바꾸기
			if(subMenuIndex == 1) {
				//first index
				...
				//last index
					g2.drawImage(shadow, -shadowSize, getHeight()/2, null);
