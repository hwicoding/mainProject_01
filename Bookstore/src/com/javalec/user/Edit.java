...
public class Edit extends JDialog {
	...
	private JButton getBtnPw() {
		if (btnPw == null) {
			...
			btnPw.setBounds(270, 280, 100, 25);
		}
		return btnPw;
	}
	private JButton getBtnEdit() {
		if (btnEdit == null) {
			...
			btnEdit.setBounds(23, 640, 140, 40);
		}
		return btnEdit;
	}
	private JButton getBtnOut() {
		if (btnOut == null) {
			...
			btnOut.setBounds(223, 640, 140, 40);
		}
		return btnOut;
	}
	...
	private JTextField getTfEmail1() {
		if (tfEmail1 == null) {
			...
			tfEmail1.setBounds(184, 470, 80, 25);
	...
	private JLabel getLblNewLabel_2() {
		if (lblNewLabel_2 == null) {
			...
			lblNewLabel_2.setBounds(15, 360, 50, 25);
		}
	...
	private JLabel getLblNewLabel_2_1() {
		if (lblNewLabel_2_1 == null) {
			...
			lblNewLabel_2_1.setBounds(15, 415, 62, 25);
		}
	...
	private JLabel getLblNewLabel_2_1_1() {
		if (lblNewLabel_2_1_1 == null) {
			...
			lblNewLabel_2_1_1.setBounds(15, 470, 50, 25);
		}
	...
	private JTextField getTfName() {
		if (tfName == null) {
			...
			tfName.setBounds(86, 360, 100, 25);
	...
	private JTextField getTfEmail() {
		if (tfEmail == null) {
			...
			tfEmail.setBounds(85, 470, 80, 25);
